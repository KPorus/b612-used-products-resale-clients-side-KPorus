...
export const route = createBrowserRouter([
    {
        ...
        children:[
            ...
            },
            {
                ...
                loader:async ({params})=>
                {
                    return fetch(`  https://b612-used-products-resale-server-side-two.vercel.app/samsung/${params.id}`)
                }
            },
            {
                path:"/apple/:id",
                ...
                loader:async ({params})=>
                {
                    return fetch(`  https://b612-used-products-resale-server-side-two.vercel.app/apple/${params.id}`)
                }
            },
            {
                path:"/walton/:id",
                ...
                loader:async ({params})=>
                {
                    return fetch(`  https://b612-used-products-resale-server-side-two.vercel.app/walton/${params.id}`)
                }
            },
        ]
    }
