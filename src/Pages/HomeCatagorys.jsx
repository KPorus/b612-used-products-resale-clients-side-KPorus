...
const HomeCatagorys = () => {
  ...
  useEffect(() => {
    fetch(" https://b612-used-products-resale-server-side-two.vercel.app/samsung")
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(" https://b612-used-products-resale-server-side-two.vercel.app/apple")
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(" https://b612-used-products-resale-server-side-two.vercel.app/walton")
      .then((res) => res.json())
